...
SECTION .data
entrada_a_leer db '/home/chus/Arqui1/DefensaProgra1/tetris.txt', 0h    ; Archivo de entrada a leer
archivo_salida db '/home/chus/Arqui1/DefensaProgra1/tetris_eco.txt', 0h       ; Archivo de salida para cargar los datos finales
...
section .text
global _start
_start:    mov ebp, esp; for correct debugging
...
Buffer:
    ...
    mov     bx, word[y_actual]    ;Se guarda y actual en la posicion del buffer correspondiente
...
Reverberacion:
;Primera parte de la multiplicacion para y_actual
    push    edx                 ;Se le hace push al registro
    push    ecx                 ;Se le hace push al registro
    push    ebx                 ;Se le hace push al registro
    push    eax                 ;Se le hace push al registro
    ...
    mov     bx, word[uno_menosAlfa]  ;Se carga el segundo operando a ebx, la direccion de memoria de la variable
    ...
    mov     dword[mulf1], ecx   ;Se carga el resultado de la multiplicacion el la primera parte del algoritmo
;*************************************************************************************************************
    ...
    mov     ecx, dword[resultado_multiplicacion] ;Se carga lo que sea que diera la multiplicacion a ecx
    mov     dword[mulf2], ecx   ;Se carga el resultado de la multiplicacion el la primera parte del algoritmo
    
    mov    edx, [mulf1]
    mov    ebx, [mulf2]
    add    edx, ebx
    mov    word[y_actual], dx
    call   Buffer
